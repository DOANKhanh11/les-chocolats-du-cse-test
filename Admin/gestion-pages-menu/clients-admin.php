                ...
                <!-- Main -->
                    <main>
                        <?php 
                            ...
                            $maBDA = new accesBDA();
                            // $nbrTotalClients = $maBDA->calculTotalClients();
                            // ============================================================
                        ?>
                        <div>
                            </br></br>
                        ...
                        <form id="search-form" class="d-flex recherche-admin" role="search">
                            ...
                            <input id="search-input-clients" class="form-control me-2" type="search" placeholder="..." aria-label="Search"></br>
                            <button class="btn btn-outline-success" style="width:50%;text-align:center;" type="submit">Rechercher</button>
                        </form>
                        <table class="table table-striped">
                            <thead id="table-head">
                                <tr>
                                    <th scope="col">Total clients enregistrés</th>
                                </tr>
                            </thead>
                                
                            <tbody id="table-body">
                                <tr>
                                    <td><?php echo $nbrTotalClients; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </main>
